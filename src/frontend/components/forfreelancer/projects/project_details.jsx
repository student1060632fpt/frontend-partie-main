                    ...
                    <div className="row">
                      <div className="col-md-4">
                        <div className="exp-detail">
                          <img className="img-fluid" alt="" src={Exp_Icon_01} />
                      ...
                      <div className="col-md-4">
                        <div className="exp-detail">
                          <img className="img-fluid" alt="" src={Exp_Icon_02} />
                          <div className="exp-info">
                      ...
                      <div className="col-md-4">
                        <div className="exp-detail">
                          <img className="img-fluid" alt="" src={Exp_Icon_03} />
                          <div className="exp-info">
                            <p>Level </p>
                            <h5>Intermediate</h5>
                          </div>
                      ...
                      <div className="col-md-4">
                        <div className="exp-detail">
                          <img className="img-fluid" alt="" src={Exp_Icon_05} />
                          <div className="exp-info">
                            <p>Experience</p>
                            <h5>+5 years</h5>
                          </div>
                      ...
                      <div className="col-md-4">
                        <div className="exp-detail">
                          <img className="img-fluid" alt="" src={Exp_Icon_06} />
                          <div className="exp-info">
                            <p>Qualifications</p>
