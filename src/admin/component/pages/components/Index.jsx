...
import { avatar_02, img_01, avatar_04, avatar_03, } from '../../../component/pages/imagepath'
              ...
              <div className="row">
                ...
                <div className="col-md-12">
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar me-1">
                        <img className="avatar-img rounded" alt="User Image" src={avatar_02} />
                      </div>
                      <div className="avatar me-1">
                        <img className="avatar-img rounded-circle" alt="User Image" src={avatar_02} />
                      </div>
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar-group">
                        ...
                        <div className="avatar">
                          <img className="avatar-img rounded-circle border border-white" alt="User Image" src={avatar_04} />
                        </div>
                        <div className="avatar">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="row row-sm align-items-center mt-3">
                    ...
                    <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                      <button type="button" className="btn w-100 btn-outline-danger active">
                        Danger
                      </button>
                    </div>
                    <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    ...
                    <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                      <button type="button" className="btn w-100 btn-outline-light active">
                        Light
                      </button>
                    </div>
                    <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="dropdown">
                    <Link className="dropdown-toggle me-1" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Dropdown </Link>
